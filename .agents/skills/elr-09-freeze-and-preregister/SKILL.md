---
name: "elr-09-freeze-and-preregister"
description: "Run ELR stage 09-freeze-and-preregister: Freeze and preregister the study. Use when this is the current stage in project/PROJECT_STATE.md or when the researcher explicitly requests this recovery stage."
---

# Run elr-09-freeze-and-preregister
...
2. Read `workflow/stages/09-freeze-and-preregister.md` completely as the single source of substantive instructions for this stage.
