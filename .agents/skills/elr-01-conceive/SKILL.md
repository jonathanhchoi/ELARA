---
name: "elr-01-conceive"
description: "Run ELR stage 01-conceive: Conceive and select a project. Use when this is the current stage in project/PROJECT_STATE.md or when the researcher explicitly requests this recovery stage."
---
...
2. Read `workflow/stages/01-conceive.md` completely as the single source of substantive instructions for this stage.
