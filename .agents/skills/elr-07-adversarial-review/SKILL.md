---
name: "elr-07-adversarial-review"
description: "Run ELR stage 07-adversarial-review: Adversarially review and freeze the design. Use when this is the current stage in project/PROJECT_STATE.md or when the researcher explicitly requests this recovery stage."
---
...
2. Read `workflow/stages/07-adversarial-review.md` completely as the single source of substantive instructions for this stage.
