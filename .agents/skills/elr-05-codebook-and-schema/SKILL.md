---
name: "elr-05-codebook-and-schema"
description: "Run ELR stage 05-codebook-and-schema: Build the codebook, schema, and unit space. Use when this is the current stage in project/PROJECT_STATE.md or when the researcher explicitly requests this recovery stage."
---

# Run elr-05-codebook-and-schema
...
2. Read `workflow/stages/05-codebook-and-schema.md` completely as the single source of substantive instructions for this stage.
