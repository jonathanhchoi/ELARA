---
name: "elr-15-robustness"
description: "Run ELR stage 15-robustness: Test prompt and model robustness. Use when this is the current stage in project/PROJECT_STATE.md or when the researcher explicitly requests this recovery stage."
---
...
2. Read `workflow/stages/15-robustness.md` completely as the single source of substantive instructions for this stage.
