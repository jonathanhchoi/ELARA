...
1. Resolve the manuscript to work on: the active `manuscript_vNNN/` or `revised_manuscript_vNNN/`, or, before Stage 18, the researcher-supplied draft under `project/inputs/manuscript/`. Record its path and hash. Never edit an input or an earlier version.
