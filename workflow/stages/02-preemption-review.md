...
- Confirm that the executive summary appears first, covers the required decision points, contains no claim or source absent from the detailed review, stays within 1,200 words and approximately three rendered pages, and is followed by a clean page break before the annotated map.
