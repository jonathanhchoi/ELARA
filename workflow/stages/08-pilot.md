...
11. Give the code, frozen artifacts, logs, and outputs to a fresh second model instance for audit. It reports bugs, nondeterminism, leakage, fragile assumptions, security issues, and missing tests in code_review.md; it does not silently fix code or recode observations.
