---
name: "elr-18-integrate-manuscript"
description: "Run ELR stage 18-integrate-manuscript: Integrate validated results into the researcher's manuscript. Use when this is the current stage in project/PROJECT_STATE.md or when the researcher explicitly requests this recovery stage."
...
2. Read `workflow/stages/18-integrate-manuscript.md` completely as the single source of substantive instructions for this stage.
