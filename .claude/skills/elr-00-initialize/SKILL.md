---
name: "elr-00-initialize"
description: "Run ELR stage 00-initialize: Initialize the project. Use when this is the current stage in project/PROJECT_STATE.md or when the researcher explicitly requests this recovery stage."
...
2. Read `workflow/stages/00-initialize.md` completely as the single source of substantive instructions for this stage.
