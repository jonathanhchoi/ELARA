---
name: "elr-02-preemption-review"
description: "Run ELR stage 02-preemption-review: Run the selected-project preemption review. Use when this is the current stage in project/PROJECT_STATE.md or when the researcher explicitly requests this recovery stage."
disable-model-invocation: true
---

# Run elr-02-preemption-review
...
2. Read `workflow/stages/02-preemption-review.md` completely as the single source of substantive instructions for this stage.
