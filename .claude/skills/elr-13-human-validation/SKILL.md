---
name: "elr-13-human-validation"
description: "Run ELR stage 13-human-validation: Run blind human validation and adjudication. Use when this is the current stage in project/PROJECT_STATE.md or when the researcher explicitly requests this recovery stage."
...
2. Read `workflow/stages/13-human-validation.md` completely as the single source of substantive instructions for this stage.
