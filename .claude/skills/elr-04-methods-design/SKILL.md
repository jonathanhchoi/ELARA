---
name: "elr-04-methods-design"
description: "Run ELR stage 04-methods-design: Design the methods. Use when this is the current stage in project/PROJECT_STATE.md or when the researcher explicitly requests this recovery stage."
disable-model-invocation: true
---

# Run elr-04-methods-design
...
2. Read `workflow/stages/04-methods-design.md` completely as the single source of substantive instructions for this stage.
